...
export const PORTFOLIO_PROJECTS: Project[] = [
  // Key Projects (Featured)
  {
    ...
    insight: "기존에는 콘텐츠의 메시지나 정보가 중요하다고 생각했지만,\n이번 프로젝트를 통해\n\n사용자의 반응은 ‘무엇을 말하느냐’보다\n‘어떻게 보여주느냐’에 더 크게 영향을 받는다는 것을 확인했습니다.\n\n특히 궁금증을 유도하는 구조가\n시청 지속과 전환에 직접적인 영향을 준다는 점에서\n\n콘텐츠의 성과는 메시지 자체보다\n구조와 흐름 설계에 의해 결정된다는 것을 체감했습니다.",
  ...
  },
  {
    ...
    insight: "기존에는 콘텐츠의 주제나 정보가 중요하다고 생각했지만,\n이번 프로젝트를 통해\n\n사용자의 반응은 ‘무엇을 말하느냐’보다\n‘어떻게 보여주느냐’에 더 크게 영향을 받는다는 것을 확인했습니다.\n\n특히 인물 간 상호작용과 갈등 구조가 있는 콘텐츠가\n사용자의 몰입도를 더 크게 좌우한다는 것을 확인했으며,\n\n이를 통해 콘텐츠의 내용보다\n‘구조와 흐름 설계’가 사용자 반응을 결정하는 핵심 요소임을 체감했습니다.",
